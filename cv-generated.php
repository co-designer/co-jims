<?php include('database.php');
	...
	if(isset($_SESSION['username']) && $l['type']=='S'){
?>
<html>
	<head>
		<style type="text/css">
	...
	<div id="page-content">
			...
			<form name="cv-generate" action="<?php echo($_SERVER['PHP_SELF']); ?>" method="post">
				<table width="700px" border="0" align="">
					<tr>
						<td align="">
							<a class="word-export" href="javascript:void(0)"> Export as Word </a> 
